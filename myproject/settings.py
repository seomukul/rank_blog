...
SECRET_KEY = 'django-insecure-6w=ucawkfbe9!202ey2t1#v04=5(%#)ws4e__*pb-_a8m(6mw!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '152.42.241.208']
...
# Custom color palette for CKEditor 5 (optional)
customColorPalette = [
    {
        'color': 'hsl(4, 90%, 58%)',
        'label': 'Red'
...
# CKEditor 5 settings
CKEDITOR_5_CUSTOM_CSS = '/static/css/path_to.css'  # Path to a custom CSS file (optional)
...
# File upload permission setting
